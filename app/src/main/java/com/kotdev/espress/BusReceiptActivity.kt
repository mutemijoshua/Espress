...
class BusReceiptActivity<IOException : Any> : AppCompatActivity() {
    ...
    private lateinit var seatNumber: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_bus_receipt)
        ...
        seatNumber= findViewById(R.id.tvSeatNumber)
